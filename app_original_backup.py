...
current_season = "sakura"  # Default seasonal theme
...
# Create Gradio interface with Japanese theme
with gr.Blocks(
    title="🎌 Classical Japanese Learning Assistant", 
    theme=current_theme,
    ...
    with gr.Column(elem_classes=["app-header"]):
        gr.Markdown(
            ...
            <div class="app-subtitle">Powered by AI with your textbook knowledge • あなたの教科書の知識でAIを活用</div>
            """,
    ...
    # Main navigation with consolidated structure
    with gr.Tabs(elem_classes=["tab-nav"]) as main_tabs:
        
        # Main Learning Interface (consolidates Chat + Grammar Search + Notes)
        with gr.Tab("🎓 Learning", elem_classes=["content-card"]) as learning_tab:
            
            # Sub-navigation for learning features
                ...
                with gr.Tab("💬 Chat Assistant"):
                    with gr.Column(elem_classes=["chat-container"]):
                        ...
                        thinking_accordion = gr.Accordion(
                            ...
                            open=False,
                            visible=False,
                            elem_classes=["thinking-accordion"]
                        )
                        with thinking_accordion:
                            thinking_content = gr.Markdown(
                                "", 
                                elem_id="thinking-content",
